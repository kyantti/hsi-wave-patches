...
# 1. Configuration
# ---------------------------------------------------------
INPUT_DIR = "data/cropped-hypercubes"  # Directory containing .npy files
...
def generate_cwt_images(spectrum, patch_idx, image_name, output_subdir):
    """
...
def generate_dwt_images(spectrum, patch_idx, image_name, output_subdir):
    """
...
def process_hyperspectral_image(npy_file_path):
    ...
    try:
        ...
        for patch_idx, spectrum in enumerate(patch_spectra):
            ...
            generate_cwt_images(spectrum, patch_idx, image_name, output_subdir)
            # Uncomment the line below if you also want DWT images
            # generate_dwt_images(spectrum, patch_idx, image_name, output_subdir)
